...
public class CityLazy {
    ...
    private Supplier<List<WeatherInfo>> history = lazily(() -> WeatherParserFromFile.parseWeather());
    public Supplier<List<WeatherInfo>> weatherHistory = lazily(()->history.get()); 
    ...
    public Supplier lazily (Supplier ip)
    {
        return ip;
    }
